...
#include <third_party/opus1_3_1/opus/opus.h>
...
static pjmedia_codec_opus_config opus_cfg =
        {
                ...
                30,                        /* Expected packet loss */
                10,//PJMEDIA_CODEC_OPUS_DEFAULT_COMPLEXITY,    /* Complexity           */
...
PJ_DEF(pj_status_t) pjmedia_codec_opus_init(pjmedia_endpt *endpt) {
    ...
    PJ_LOG(2, (THIS_FILE, "pjmedia_codec_opus_init"));
