/* $Id: echo_common.c 5186 2015-10-06 05:57:51Z ming $ */
/* 
 ...
 * WebRTC 3A
 */
#if defined(PJMEDIA_HAS_APM_AEC) && PJMEDIA_HAS_APM_AEC!=0
static struct ec_operations apm_aec_op =
{
    "WebRTC APM AEC",
    &apm_aec_create,
    &apm_aec_destroy,
...
#if defined(PJMEDIA_HAS_APM_AEC) && PJMEDIA_HAS_APM_AEC!=0
    } else if ((options & PJMEDIA_ECHO_ALGO_MASK) == PJMEDIA_ECHO_APM ||
               (options & PJMEDIA_ECHO_ALGO_MASK) == PJMEDIA_ECHO_DEFAULT)
    {
        ec->op = &apm_aec_op;
#endif
