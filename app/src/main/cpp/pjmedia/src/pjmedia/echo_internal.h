/* $Id: echo_internal.h 5186 2015-10-06 05:57:51Z ming $ */
/* 
...
PJ_DECL(pj_status_t) apm_aec_create(pj_pool_t *pool,
                                       unsigned clock_rate,
                                       unsigned channel_count,
                                       unsigned samples_per_frame,
                                       unsigned tail_ms,
                                       unsigned options,
                                       void **p_echo );
PJ_DECL(pj_status_t) apm_aec_destroy(void *state );
PJ_DECL(void) apm_aec_reset(void *state );
PJ_DECL(pj_status_t) apm_aec_playback(void *state,
					pj_int16_t *play_frm );
PJ_DECL(pj_status_t) apm_aec_capture(void *state,
				       pj_int16_t *rec_frm,
				       unsigned options );
