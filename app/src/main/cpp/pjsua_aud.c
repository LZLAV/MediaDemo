...
//    }
//
//    pjmedia_conf_set_pause_sound_cb(pjsua_var.mconf, pause_sound);
//	pjmedia_conf_set_resume_sound_cb(pjsua_var.mconf, resume_sound);
//
